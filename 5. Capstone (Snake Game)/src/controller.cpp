...
//queue recieve message definition
...
//modified the handle to addapt to the new design of multiple thread communication
...
// adding definition for the get control value method
Snake::Direction Controller::GetControl()
{
  return Queue.receive();
}
// adding definition for the send control value method
